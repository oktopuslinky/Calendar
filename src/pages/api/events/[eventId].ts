...
import type { EventType, EventStore, ErrorResponse} from "@/pages/api/data/dataTypes";
import { promises as fs } from 'fs';
import { console } from 'inspector/promises';

export default async function handler(req: NextApiRequest, res: NextApiResponse<EventType|ErrorResponse>) {
  if (req.method === 'GET') {
